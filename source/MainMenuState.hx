...
{
	public static var unknownEngineVersion:String = '0.5 ALPHA';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 70, 0, "Unknown Engine v" + unknownEngineVersion, 12);
